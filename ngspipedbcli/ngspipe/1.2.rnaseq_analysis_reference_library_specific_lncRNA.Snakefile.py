...
rna_library = "--rna-strandness RF" # "--rna-strandness RF"(fr-firststrand) or "--rna-strandness FR"(fr-secondstrand)
...
rule all:
    input:
        ...
        #
        # 4. assembly
        transcript_assembly_result         = join(transcript_assembly_outdir, "merged.gtf")
        #
        # 5. lncRNA
        lncRNA_identification_result       = config["resultfolder"] + "/filter_out/lncRNA.gtf",
        #
        # 6. qunatification #
