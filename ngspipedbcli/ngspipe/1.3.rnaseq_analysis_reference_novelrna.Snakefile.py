...
# 5. lncRNA identify
identify_lncRNA_outdir = join(config["resultsDir"], "identify_lncRNA")
...
rule all:
    input:
        ...
        #
        # 4. assembly stringtie
        stringtie_mergedGtf                = join(transcript_assembly_outdir, "merged.gtf"),
        #
        # 5. lncRNA identify
...
include: join("rules", "identify.lncRNA.Snakefile.py")
