...
rule download_sra_data:
    ...
    shell:
        ...
        ascp -QT -l 300m -P33001 -i /home/zhangxuan/miniconda3/envs/snakemake/etc/asperaweb_id_dsa.openssh era-fasp@fasp.sra.ebi.ac.uk:/vol1/fastq/SRR665/SRR6656275/SRR6656275_1.fastq.gz .
        wget -c ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR665/SRR6656275/SRR6656275_1.fastq.gz .
        '''

# aspera (ascp) https://zhuanlan.zhihu.com/p/47024487
# conda install -c rpetit3 aspera-connect
# https://cloud.tencent.com/developer/article/1486134
