...
rule diff_gene_enrich_by_clusterprofiler:
    ...
    output:
         diff_gene_enrich_ok = touch(join(gokegg_enrich_outdir, 'clusterprofiler', 'diff_gene_enrich_ok.ok')),
...
rule enrich:
    message:
        ...
        '''
    input:
        diff_gene_enrich_ok = join(gokegg_enrich_outdir, 'clusterprofiler', 'diff_gene_enrich_ok.ok'),
    output:
