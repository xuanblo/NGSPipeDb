...
WOOEY_CELERY = get('WOOEY_CELERY', False)
...
WOOEY_FILE_DIR = get('WOOEY_FILE_DIR', 'wooey_runing_results_files')
...
WOOEY_SITE_NAME = get('WOOEY_SITE_NAME', _('NGSTools'))
WOOEY_SITE_TAG = get('WOOEY_SITE_TAG', _('A web UI for Python scripts to do bioinformatics analysis'))
