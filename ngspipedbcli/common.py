...
pipes_dict = {
    ...
    'ngspipe-rnaseq-lncRNA': {
        'snakefile': os.path.join(ngspipe_dir, '1.2.rnaseq_analysis_reference_basic.Snakefile.py'),
        'configfile': os.path.join(ngspipe_dir, 'config/rnaseq.config.yaml'),
        'env_path': os.path.join(ngspipe_dir, 'envs/requirements_rnaseq.yaml'),
        'env_name': 'ngspipe-rnaseq-basic',
        'testdata': 'preparing',
        'database': [],
        'packenv': ['preparing', 'preparing'],
    }, 
    'ngspipe-rnaseq-trinity': {
        'snakefile': os.path.join(ngspipe_dir, '1.3.rnaseq_analysis_reference_basic.Snakefile.py'),
        'configfile': os.path.join(ngspipe_dir, 'config/rnaseq.config.yaml'),
        'env_path': os.path.join(ngspipe_dir, 'envs/requirements_rnaseq.yaml'),
        'env_name': 'ngspipe-rnaseq-basic',
        'testdata': 'preparing',
